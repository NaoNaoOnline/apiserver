...
var jsonPatchOperationEmptyError = &tracer.Error{
	...
	Desc: "The request expects the JSON-Patch operation not to be empty. The JSON-Patch operation was found to be empty for the request. Therefore the request failed.",
}
...
var jsonPatchOperationInvalidError = &tracer.Error{
	...
	Desc: "The request expects the JSON-Patch operation to be one of [replace]. The JSON-Patch operation was not found to be one of [replace] for the request. Therefore the request failed.",
}
...
var jsonPatchPathEmptyError = &tracer.Error{
	...
	Desc: "The request expects the JSON-Patch path not to be empty. The JSON-Patch path was found to be empty for the request. Therefore the request failed.",
}
...
var jsonPatchPathInvalidError = &tracer.Error{
	...
	Desc: "The request expects the JSON-Patch path to be one of [/text]. The JSON-Patch path was not found to be one of [/text] for the request. Therefore the request failed.",
}
