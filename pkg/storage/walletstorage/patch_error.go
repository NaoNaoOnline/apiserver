...
var jsonPatchPathInvalidError = &tracer.Error{
	...
	Desc: "The request expects the JSON-Patch path prefix to be one of [/labl/data]. The JSON-Patch path prefix was not found to be one of [/labl/data]. Therefore the request failed.",
}
