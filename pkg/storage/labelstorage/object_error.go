...
var labelPrflInvalidError = &tracer.Error{
	...
	Desc: "The request expects the label prfl to be one of [Twitter Warpcast]. The label kind was not found to be one of [Twitter Warpcast]. Therefore the request failed.",
}
